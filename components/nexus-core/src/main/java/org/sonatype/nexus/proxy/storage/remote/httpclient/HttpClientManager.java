...
public interface HttpClientManager
{
     ...
     * in this case. If calling this method outside of context update step, the previous call is fine and will not loop.
     * 
    ...
    /**
     * Releases the {@link HttpClient} for given {@link ProxyRepository}. To be called whenever the instance needs to be
