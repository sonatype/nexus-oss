    ...
    implements RecordStoreSchema
{
  ...
  static {
    ...
    OTYPES.put(RecordId.class, OType.LINK);
  }
  ...
  private static RecordType getRecordType(OClass oClass) {
    ...
    for (OProperty oProperty : oClass.properties()) {
      ...
      Class javaType = oType.getDefaultJavaType();
      if (oType == OType.LINK) {
        javaType = RecordId.class;
      }
      FieldDefinition field = new FieldDefinition(oProperty.getName(), javaType);
