    ...
    extends AbstractModule
{
  ...
  /**
   * Pre-configuration filter to help plugins minimise their binding configuration.
   * 
   * @param space The plugin space being configured
   * @return {@code true} if the interceptor should be applied, otherwise {@code false}
   */
  public boolean appliesTo(final ClassSpace space) {
    return true;
  }
