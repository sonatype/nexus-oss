...
public class DefaultFSLocalRepositoryStoragePerformance2IT
{
    ...
    final private RepositoryItemUidFactory repositoryItemUidFactory = Mockito.mock( RepositoryItemUidFactory.class );
        ...
        throws Exception
    {
        ...
        repository = new TMockRepository( "testRetieveItem-repo", repositoryItemUidFactory );
