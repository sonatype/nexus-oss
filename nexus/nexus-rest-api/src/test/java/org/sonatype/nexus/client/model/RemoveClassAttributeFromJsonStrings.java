...
//    }
    ...
    public void testScheduleJsonStringWithOutClassAttribute()
    {
        ...
        ScheduledServiceResourceResponse repoRouteResourceResponse = (ScheduledServiceResourceResponse) representation.getPayload( new ScheduledServiceResourceResponse() );
