    ...
    extends AbstractNexusTestCase
{
    ...
    public void testFeedSources() throws Exception
    {
       ...
       // need to test the protected method, its a little hacky, but the problem i am trying to test has to do with Plexus loading this class
       ...
       Method getFeedMethod = feedResource.getClass().getDeclaredMethod( "getFeed", Context.class, Request.class, String.class );
       
       SyndFeed feed = (SyndFeed) getFeedMethod.invoke( feedResource, null, null, "brokenArtifacts" );
