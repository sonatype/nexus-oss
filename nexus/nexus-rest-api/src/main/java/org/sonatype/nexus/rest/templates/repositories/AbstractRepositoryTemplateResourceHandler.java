...
public abstract class AbstractRepositoryTemplateResourceHandler
    extends AbstractRepositoryResourceHandler
{
     ...
     * @param response
     */
    public AbstractRepositoryTemplateResourceHandler( Context context, Request request, Response response )
    {
