...
public abstract class AbstractComponentPlexusResource
    ...
    implements Contextualizable
{
        ...
        throws ResourceException
    {
        ...
        List<ComponentDescriptor> componentMap = this.container
        .getComponentDescriptorList( role );
        ...
        for ( ComponentDescriptor componentDescriptor : componentMap )
        {
            ...
            resource.setDescription( componentDescriptor.getDescription() );
