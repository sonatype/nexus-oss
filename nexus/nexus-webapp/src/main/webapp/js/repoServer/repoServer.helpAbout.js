...
Ext.extend(Sonatype.repoServer.HelpAboutPanel, Ext.Panel, {
  getHelpText : function() {
    return '<div class="little-padding">'
        ...
        + '<br><br>You should have received a copy of the GNU General Public License Version 3 along with this program. If not, see <a href="http://www.gnu.org/licenses/" target="_new">http://www.gnu.org/licenses/</a>' + '<br>Sonatype Nexus&trade; '
        + Sonatype.utils.edition + ' Version is available from Sonatype, Inc.' + '<br>&quot;Sonatype&quot; and &quot;Sonatype Nexus&quot; are trademarks of Sonatype, Inc.' + '</div>'
  }
});