...
Ext.onReady(function() {
      ...
      var adsenseHost = 'filetree.localhost' === window.location.host || 'filetree.extjs.eu' === window.location.host;
      ...
      page.langCombo.on('select', function() {
            document.cookie = 'locale=' + this.getValue();
          });
