 ...
 ************************************ See Sonatype comments at bottom ******************
 */
...
Ext.dd.DropTarget = function(el, config){
    ...
    Ext.dd.DropTarget.superclass.constructor.call(this, this.el.dom, this.ddGroup || this.group, 
          config || {isTarget: true}); //{isTarget: true});
...
Ext.form.Field = Ext.extend(Ext.BoxComponent,  {
    ...
    adjustWidth : function(tag, w){
        tag = tag.toLowerCase();
        if(typeof w == 'number') { // && !Ext.isSafari){ //@jrichard
            ...
            }else if(Ext.isSafari3){  //@jrichard: assumes we are serving xhtml transitional doctype
                if(tag == 'input'){
                    return w - 8;
                }
            }
...
/*
 * ln 10023 : allow config to pass thru to Ext.dd.DDTarget constructor so padding may
   ...
   ln 25778, 25796-25800 : modified input text sizing for Safari3 in strict mode bug.
   
   ln 5082: make default headers the *default* and overridable by requests config headers
   
   ln 5836: case "P": for date parsing with Z UTC
   
   ln 6629: NO CHANGE, but want to change encoding of date to be UTC: http://extjs.com/forum/showthread.php?t=26862
*/
