      ...
      initComponent : function() {
        ...
        Ext.apply(this, {
              store : new Ext.data.SimpleStore({
                    ...
                    data : [['cs_CZ', 'Český', 'ux-flag-cz'], ['de_DE', 'Deutsch', 'ux-flag-de'], ['fr_FR', 'French', 'ux-flag-fr'], ['nl_NL', 'Dutch', 'ux-flag-nl'], ['en_US', 'English', 'ux-flag-us'], ['ru_RU', 'Russian', 'ux-flag-ru'],
                        ['sk_SK', 'Slovenský', 'ux-flag-sk'], ['es_ES', 'Spanish', 'ux-flag-es'], ['tr_TR', 'Turkish', 'ux-flag-tr']]
                  }),
              valueField : 'langCode',
