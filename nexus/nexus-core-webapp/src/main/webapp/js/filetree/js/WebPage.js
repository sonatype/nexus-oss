 ...
 * @date 6. April 2008
 * @version $Id: WebPage.js 169 2008-04-11 21:10:41Z jozo $
 * @license WebPage.js is licensed under the terms of the Open Source LGPL 3.0
...
Ext.override(WebPage, {
      ...
      navlinksTpl : new Ext.XTemplate('<ul>' + '<tpl for="navlinks">' + '<li><a href="{href}" target="{target}">{text}</a></li>' + '</tpl>' + '</ul><div class="cleaner"></div>'),
      render : function() {
        ...
        // theme select combo
        var themeCt = this.north.createChild({
              tag : 'div',
              id : 'themect',
              cls : 'x-hidden'
            });
        ...
        if (this.langCombo)
        {
          var langCt = this.north.createChild({
                tag : 'div',
                id : 'langct',
                cls : 'x-hidden'
              });
        ...
        if (this.navlinks)
        {
          this.navlinksTpl.overwrite(this.nav, {
