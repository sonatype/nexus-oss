    ...
    implements StaticResource
{
    ...
    public PluginStaticResource( ClassLoader classLoader, PluginStaticResourceModel model )
    {
        this( classLoader, model.getResourcePath(), model.getPublishedPath(), model.getContentType() );
    }

    public PluginStaticResource( ClassLoader classLoader, String resourcePath, String publishedPath, String contentType )
    {
    ...
    public long getSize()
    {
        ...
        try
        {
            urlConnection = classLoader.getResource( resourcePath ).openConnection();
