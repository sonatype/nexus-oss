    ...
    extends AbstractMigrationIntegrationTest
{
        ...
        throws Exception
    {
        ...
        assertThat( "SHA1 are equal", FileTestingUtils.compareFileSHA1s( artifactFile, dArtifact ) );

        RepositoryResource repo = (RepositoryResource) repositoryUtil.getRepository( repoId );
        assertThat( repo.getWritePolicy(), is( equalTo( RepositoryWritePolicy.ALLOW_WRITE.name() ) ) );
    }
