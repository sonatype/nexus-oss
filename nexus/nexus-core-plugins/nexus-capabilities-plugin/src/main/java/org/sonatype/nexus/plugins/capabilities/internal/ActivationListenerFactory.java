...
/**
 * Default {@link org.sonatype.nexus.plugins.capabilities.api.CapabilityReference} implementation.
 *
 * @since 1.10.0
 */
@Named
@Singleton
class ActivationListenerFactory
    extends AbstractLoggingComponent
{
    ...
    @Inject
    ActivationListenerFactory( final NexusEventBus eventBus )
    {
        this.eventBus = checkNotNull( eventBus );
    }

    public Listener create( final CapabilityReference reference )
    {
        return new Listener( reference );
    }
    ...
    class Listener
    {
        ...
        Listener( final CapabilityReference reference )
        {
