...
@Named
@Singleton
public class CapabilitiesLoaderHandler
    implements NexusEventBus.Handler
{
    ...
    @Inject
    public CapabilitiesLoaderHandler( final CapabilityConfiguration capabilitiesConfiguration )
    {
        this.capabilitiesConfiguration = checkNotNull( capabilitiesConfiguration );
    }

    public void handle( final NexusInitializedEvent evt )
    {
        try
        {
