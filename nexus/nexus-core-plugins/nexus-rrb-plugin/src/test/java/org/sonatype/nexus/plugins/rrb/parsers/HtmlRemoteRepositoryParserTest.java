...
public class HtmlRemoteRepositoryParserTest extends RemoteRepositoryParserTestAbstract {
    ...
    public void testGetLinkName4(){
        assertEquals( "text/", parser.getLinkName(new StringBuilder("<a href=\"abc\"><img src=\"abc\" alt=\"abc\"/>text/</a>")));
    }
    ...
    public void testGetLinkName6(){
        assertEquals( "text/", parser.getLinkName(new StringBuilder("<a href=\"abc\">text/<img src=\"abc\" alt=\"abc\"/></a>")));
    }
