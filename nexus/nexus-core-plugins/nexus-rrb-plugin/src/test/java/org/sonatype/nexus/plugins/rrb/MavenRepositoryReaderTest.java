...
/**
 * In this test we use example repo files that placed in the test resource
 * catalogue To access these files locally via MavenRepositoryReader that
 * requires the http-protocol we start a Jetty server
 * 
 * @author bjorne
 * 
 */
public class MavenRepositoryReaderTest {
	...
	public void testReadS3() {
		List<RepositoryDirectory> result = reader.extract(
				getURLForTestRepoResource("s3Example"), localUrl, null, "test");
		assertEquals(14, result.size());
	}

	/**
	 * Below follows a set of tests of some typical existing repos The
	 * respectively repo's top level is stored as a file in the ordinary test
	 * resource catalog. Each file has a name indicating the repo it is taken
	 * from and an extension with the date it was downloaded in the format
	 * YYYYMMDD.
	 */
	...
	public void testAmazon_20100118() {
		...
		List<RepositoryDirectory> result = reader.extract(
				getURLForTestRepoResource("Amazon_20100118"), localUrl, null,
				"test");
	...
	public void testApache_Snapshots() {
		...
		List<RepositoryDirectory> result = reader.extract(
				getURLForTestRepoResource("Apache_Snapshots_20100118"), localUrl, null,
				"test");
	...
	public void testCodehaus_Snapshots() {
		...
		List<RepositoryDirectory> result = reader.extract(
				getURLForTestRepoResource("Codehaus_Snapshots_20100118"), localUrl,
				null, "test");
		assertEquals(3, result.size());
	}
	...
	public void testGoogle_Caja() {
		...
		List<RepositoryDirectory> result = reader.extract(
				getURLForTestRepoResource("Google_Caja_20100118"), localUrl, null,
				"test");
		assertEquals(3, result.size());
	}
	...
	public void testGoogle_Oauth() {
		...
		List<RepositoryDirectory> result = reader.extract(
				getURLForTestRepoResource("Google_Oauth_20100118"), localUrl, null,
				"test");
	...
	public void testJBoss_Maven_Release_Repository() {
		...
		List<RepositoryDirectory> result = reader.extract(
				getURLForTestRepoResource("JBoss_Maven_Release_Repository_20100118"),
				localUrl, null, "test");
	...
	public void testMaven_Central() {
		...
		List<RepositoryDirectory> result = reader.extract(
				getURLForTestRepoResource("Maven_Central_20100118"), localUrl, null,
				"test");
	...
	public void testNexus_Repository_Manager() {
		...
		List<RepositoryDirectory> result = reader.extract(
				getURLForTestRepoResource("Nexus_Repository_Manager_20100118"),
				localUrl, null, "test");
	...
	public void testEviwares_Maven_repo() {
		...
		List<RepositoryDirectory> result = reader.extract(
				getURLForTestRepoResource("Eviwares_Maven_repo_20100118"), localUrl,
				null, "test");
	...
	public void testjavaNet_repo() {
		...
		List<RepositoryDirectory> result = reader.extract(
				getURLForTestRepoResource("java.net_repo_20100118"), localUrl, null,
				"test");
	...
	public void testCodehaus() {
		...
		List<RepositoryDirectory> result = reader.extract(
				getURLForTestRepoResource("Codehaus_20100118"), localUrl, null, "test");
	...
	public void testjavaNet2() {
		...
		List<RepositoryDirectory> result = reader.extract(
				getURLForTestRepoResource("java.net2_20100118"), localUrl, null, "test");
	...
	public void testOpenIonaCom_Releases() {
		...
		List<RepositoryDirectory> result = reader.extract(
				getURLForTestRepoResource("Open.iona.com_Releases_20100118"), localUrl,
				null, "test");
		assertEquals(8, result.size());
	}

	/*@Test(timeout = 5000)
	public void testterracotta() {
		// Fetched from URI http://download.terracotta.org/maven2/
		List<RepositoryDirectory> result = reader
				.extract(getURLForTestRepoResource("terracotta_20100118"), localUrl,
						null, "test");
	...
	public void testSpringsource() {
		...
		List<RepositoryDirectory> result = reader.extract(
				getURLForTestRepoResource("Springsource_20100118"), localUrl, null,
				"test");
