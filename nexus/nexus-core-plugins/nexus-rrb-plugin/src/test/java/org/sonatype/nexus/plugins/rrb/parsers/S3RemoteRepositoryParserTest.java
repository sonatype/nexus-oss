...
public class S3RemoteRepositoryParserTest extends RemoteRepositoryParserTestAbstract {
    ...
    @Test
    public void testRepoSize1() throws Exception {
    ...
    public void testExtractContent() {
    	...
    	assertEquals(localUrl + "?remoteurl=" + remoteUrl +
    				 "milestone/org/springframework/batch/org.springframework.batch.archetype.simple.cli/" +
    				 "?id=" + id, repositoryDirectory.getResourceURI());
    	assertEquals("/" + "milestone/org/springframework/batch/org.springframework.batch.archetype.simple.cli/", repositoryDirectory.getRelativePath());
    }
    ...
    @Test
    public void testWithOneExcluded() throws Exception {
