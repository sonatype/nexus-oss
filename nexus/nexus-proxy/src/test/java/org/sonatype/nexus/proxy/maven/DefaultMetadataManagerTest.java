...
public class DefaultMetadataManagerTest
{
    ...
    public void getTimeForMetadataTimestampMaven2Normal()
    {
        ...
        assertThat(DefaultMetadataManager.getTimeFromMetadataTimestampMaven2( "20101224.124422" ), is(1293207262000L));
    }
    ...
    public void getTimeForMetadataTimestampMaven3UpdatedNormal()
    {
        ...
        assertThat(DefaultMetadataManager.getTimeFromMetadataTimestampMaven3Updated( "20101224124422" ), is(1293207262000L));
    }
