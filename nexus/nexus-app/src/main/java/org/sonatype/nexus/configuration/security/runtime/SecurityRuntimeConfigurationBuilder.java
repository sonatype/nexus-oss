 ...
 * @author cstamas
 */
public interface SecurityRuntimeConfigurationBuilder
{

    String ROLE = SecurityRuntimeConfigurationBuilder.class.getName();

    void initialize( NexusSecurityConfiguration configuration );
}
