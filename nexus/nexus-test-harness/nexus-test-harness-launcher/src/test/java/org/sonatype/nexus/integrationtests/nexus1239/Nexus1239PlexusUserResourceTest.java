...
public class Nexus1239PlexusUserResourceTest extends AbstractNexusIntegrationTest
{

    @SuppressWarnings("unchecked")
    @Test
    public void getUserTestWithSource() throws IOException
    {
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void getUserTestWithOutSource() throws IOException
    {
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void getUserTestWithAllSource() throws IOException
    {
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void getUsersTestAllSource() throws IOException
    {
        UserMessageUtil userUtil = new UserMessageUtil(this.getJsonXStream(), MediaType.APPLICATION_JSON);
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void junkSourceTest() throws IOException
    {
