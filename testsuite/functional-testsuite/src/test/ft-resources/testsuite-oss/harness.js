      ...
      items: [
...

        {
          ...
          items: [
            ...
            { url: 'testsuite-oss/framework/drilldown_back_button.t.js' }
          ]
        }
      ]
    },
      ...
      items: [
        {
          ...
          items: [
            ...
            { url: 'testsuite-oss/security/security_ssl_certificates.t.js' }
          ]
        }
      ]
    },
      ...
      items: [
        {
          group: 'FT',
          items: [
            { url: 'testsuite-oss/support/support_logging.t.js' },
