 ...
 */
    ...
    Ext.lib.Ajax = {
        request : function(method, uri, cb, data, options) {
            if(options){
                ...
                if(options.xmlData){
                    ...
                    //method = 'POST'; //@jrichard: take method from config to accept PUT or POST
        ...
        {   //Safari and IE don't always overwrite headers correctly, so need to merge default and provide headers before writing
            if (this.hasDefaultHeaders && this.hasHeaders) {
...
/*
 ** Lines 702 & 706: accept HTTP method from config, don't force POST
 ** 1086-1114: altered application of headers to requests, since IE/Safari don't allow setting the same header twice
*/