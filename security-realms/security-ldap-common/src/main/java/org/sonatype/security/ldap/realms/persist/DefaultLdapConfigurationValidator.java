    ...
    implements ConfigurationValidator
{
        ...
        else
        {
            ...
            if ( configuration.getUserAndGroupConfig() != null )
            {
                ValidationResponse vr =
                    this.validateUserAndGroupAuthConfiguration( null, configuration.getUserAndGroupConfig() );
                this.mergeValidationResponse( vr, response );
            }
            else
            {
            ...
            && !connectionInfo.getAuthScheme().toLowerCase().equals( "none" ) )
        {
            ...
            if ( StringUtils.isEmpty( connectionInfo.getSystemUsername() ) )
            {
                ValidationMessage msg =
                    new ValidationMessage( "systemUsername",
            ...
            {
                ValidationMessage msg =
                    new ValidationMessage( "systemPassword",
                                                                     ...
                                                                     CUserAndGroupAuthConfiguration userAndGroupAuthConf )
    {
        ...
        {
            ValidationMessage msg =
                new ValidationMessage( "userRealNameAttribute", "User Real Name Attribute cannot be empty." );
            response.addValidationError( msg );
        }
        if ( StringUtils.isEmpty( userAndGroupAuthConf.getEmailAddressAttribute() ) )
        {
            ValidationMessage msg =
                new ValidationMessage( "emailAddressAttribute", "Email Address Attribute cannot be empty." );
            response.addValidationError( msg );
        }
            ...
            && StringUtils.isEmpty( userAndGroupAuthConf.getUserMemberOfAttribute() ) )
        {
            ...
            {
                ValidationMessage msg =
                    new ValidationMessage( "groupIdAttribute",
            ...
            {
                ValidationMessage msg =
                    new ValidationMessage( "groupMemberAttribute",
            ...
            {
                ValidationMessage msg =
                    new ValidationMessage( "groupMemberFormat",
            ...
            {
                ValidationMessage msg =
                    new ValidationMessage( "groupObjectClass",
