...
import org.sonatype.nexus.test.booter.JettyServerNexusBooter;
...
public class NexusStatusUtil
{
  ...
  {
    nexusBooter =
        new JettyServerNexusBooter(new File(TestProperties.getAll().get("nexus.base.dir")).getAbsoluteFile(), port);
  }
