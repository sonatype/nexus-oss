 ...
 * (usually few files put in well know places). Repository like these usually have "central meta data" or one single (or
 * multiple, but way lass that artifacts for example) monolithic meta data. These usually make possible more "stable" or
