    ...
    extends NexusTestSupport
{
        ...
        throws Exception
    {
        ...
        server = Proxy.withPort( 0 ).serve( PATH ).withBehaviours( recordedRequests, content( CONTENT ) ).start();
        ...
        throws Exception
    {
        ...
        server.stop();
        server =
            Proxy.withPort( port ).serve( PATH ).withBehaviours( recordedRequests,
