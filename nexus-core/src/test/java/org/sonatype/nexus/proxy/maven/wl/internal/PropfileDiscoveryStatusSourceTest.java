    ...
    extends AbstractWLProxyTest
{
        ...
        throws Exception
    {
        ...
        final WLDiscoveryStatus older =
            new WLDiscoveryStatus( DStatus.SUCCESSFUL, "strategyId", "message", System.currentTimeMillis() );
        propsSource.write( older );
        final WLDiscoveryStatus newer = propsSource.read();
