 ...
 */
package org.sonatype.nexus.repository.yum.client.rest;
...
import org.sonatype.nexus.repository.yum.client.internal.JerseyYum;
    ...
    implements SubsystemFactory<Yum, JerseyNexusClient>
{
    ...
    {
        return new JerseyYum( nexusClient, repositoriesFactory.create( nexusClient ) );
    }
