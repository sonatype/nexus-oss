...
public interface StorageContext
{
     ...
     * {@link #removeContextObject(String)} increases this number, while other "read" operations does not. Also, even if
     ...
     * 
     * @return the context generation, that grows by changes made against context (nothing guarantees next generation is
