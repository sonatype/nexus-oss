...
public class JerseyMavenHostedRepository
    extends JerseyHostedRepository
    implements MavenHostedRepository
{

    public JerseyMavenHostedRepository( final JerseyNexusClient nexusClient )
    {
        super( nexusClient );
    }
    ...
    @Override
    public MavenHostedRepository withRepoPolicy( final String policy )
    {
        super.withRepoPolicy( policy );
        return this;
    }

    @Override
    public MavenHostedRepository withWritePolicy( final String policy )
    {
        super.withWritePolicy( policy );
        return this;
    }
}
