...
public class JerseyMavenProxyRepository
    extends JerseyProxyRepository
    implements MavenProxyRepository
{

    public JerseyMavenProxyRepository( final JerseyNexusClient nexusClient )
    {
        super( nexusClient );
    }
    ...
    @Override
    public MavenProxyRepository withRepoPolicy( final String policy )
    {
    ...
    @Override
    public MavenProxyRepository withRemoteUrl( final String remoteUrl )
    {
        super.withRemoteUrl( remoteUrl );
        return this;
    }
