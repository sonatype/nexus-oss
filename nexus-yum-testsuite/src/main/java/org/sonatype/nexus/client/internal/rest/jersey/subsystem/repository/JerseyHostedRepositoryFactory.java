...
public class JerseyHostedRepositoryFactory
    extends JerseyGenericRepositoryFactory
{
    ...
    @Override
    public JerseyHostedRepository create( final JerseyNexusClient nexusClient )
    {
        return new JerseyHostedRepository( nexusClient );
    }
}
