 ...
 */
package org.sonatype.nexus.site.plugin.ui;
    ...
    extends AbstractNexusIndexHtmlCustomizer
{
    ...
    public String getPostHeadContribution( Map<String, Object> ctx )
    {
        final String version = getVersionFromJarFile(
            "/META-INF/maven/org.sonatype.nexus.plugins/nexus-site-plugin/pom.properties"
        );

        return "<script src=\"static/js/nexus-site-plugin-all.js" + ( version == null ? "" : "?" + version )
