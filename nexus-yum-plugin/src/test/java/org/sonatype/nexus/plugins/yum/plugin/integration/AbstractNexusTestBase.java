...
public class AbstractNexusTestBase
{
    ...
    private static final String REPO_XML = "<repository>" + "<data>"
        + "<contentResourceURI>%s/repositories/%s</contentResourceURI>" + "<id>%s</id>" + "<name>%s</name>"
        + "<provider>maven2</provider>" + "<providerRole>org.sonatype.nexus.proxy.repository.Repository</providerRole>"
        + "<format>maven2</format>" + "<repoType>hosted</repoType>" + "<exposed>true</exposed>"
        + "<writePolicy>ALLOW_WRITE</writePolicy>" + "<browseable>true</browseable>" + "<indexable>true</indexable>"
        + "<notFoundCacheTTL>1440</notFoundCacheTTL>" + "<repoPolicy>RELEASE</repoPolicy>" + "</data>"
        + "</repository>";

    protected HttpClient client = new DefaultHttpClient();

    protected HttpResponse executePost( String url, HttpEntity entity, Header... headers )
    ...
    protected HttpResponse executePut( String url, HttpEntity entity, Header... headers )
        throws AuthenticationException, UnsupportedEncodingException, IOException, ClientProtocolException
    {
        url = serviceUrl( url );
    ...
    protected void setCredentials( HttpRequest request )
    ...
    protected HttpResponse executeGetWithResponse( String url )
        throws AuthenticationException, IOException
    {
        url = serviceUrl( url );
    ...
    protected HttpResponse executeDeleteWithResponse( String url )
        throws AuthenticationException, IOException
    {
        if ( !url.startsWith( "http" ) )
        {
    ...
    protected String content( HttpResponse response )
        throws IOException
    {
    ...
    protected void deployToRepo( File file, String artifactId, String groupId, String version, String repositoryId )
    ...
    protected void deployRpmToRepo( String artifactId, String groupId, String version, String repositoryId )
        throws NoSuchAlgorithmException, IOException, AuthenticationException
    {
        deployToRepo( RepositoryTestUtils.createDummyRpm( artifactId, version ), artifactId, groupId, version,
            repositoryId );
    }

    protected void givenTestRepository( String repositoryId )
        throws Exception
    {
    ...
    private StringEntity createRepositoryXml( String repositoryId )
        throws UnsupportedEncodingException
    {
        StringEntity entity =
            new StringEntity( format( REPO_XML, SERVICE_BASE_URL, repositoryId, repositoryId, repositoryId ) );
        entity.setContentType( "application/xml" );
        return entity;
    }

    protected String gzipResponseContent( HttpResponse response )
        throws IOException
    {
    ...
    protected void givenGroupRepository( String repoId, String providerId, Repository... memberRepos )
        throws AuthenticationException, UnsupportedEncodingException, IOException, ClientProtocolException
    {
    ...
    protected void givenUploadedRpmToStaging( String groupId, String artifactId, String version )
        throws NoSuchAlgorithmException, IOException, AuthenticationException
    {
    ...
    private void deployFile( final File file, String groupId, String artifactId, String version, String repoUrl )
        throws AuthenticationException, IOException, ClientProtocolException
    {
    ...
    protected String getStagingRepositoryId( String profileId )
        throws Exception
    {
