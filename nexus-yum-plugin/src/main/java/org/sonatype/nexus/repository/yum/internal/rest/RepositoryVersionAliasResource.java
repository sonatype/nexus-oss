...
/**
 * Resource providing an aliases view on the repositories provided by Nexus. That means, that you can configure serveral
...
public class RepositoryVersionAliasResource
    ...
    implements PlexusResource
{
        ...
        throws ResourceException
    {
        ...
        {
            throw new ResourceException( Status.CLIENT_ERROR_NOT_FOUND, "Could not find alias " + alias
                + " for repository " + repositoryId, e );
        }
    }
