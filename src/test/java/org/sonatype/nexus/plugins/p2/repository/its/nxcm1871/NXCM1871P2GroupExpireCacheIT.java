    ...
    extends AbstractNexusProxyP2IntegrationIT
{
        ...
        throws Exception
    {
        ...
        // check new content
        final File newContentXml = new File( localStorageDir, "p2repo3/content.xml" );
        ...
        final File repoNxcm1871 = new File( localStorageDir, "nxcm1871" );
        FileUtils.copyFileToDirectory( newContentXml, repoNxcm1871 );
        final File newArtifactsXml = new File( localStorageDir, "p2repo3/artifacts.xml" );
