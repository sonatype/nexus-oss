    ...
    extends AbstractLdapRestTest
{
      ...
      throws Exception
  {
    ...
    connectionDto.setCacheTimeout(30); // unused and defaulted
      ...
      throws Exception
  {
    ...
    this.lookup(LdapConfigurationManager.class).deleteLdapServerConfiguration(ldapClientConfigurations.get("default").getId());
