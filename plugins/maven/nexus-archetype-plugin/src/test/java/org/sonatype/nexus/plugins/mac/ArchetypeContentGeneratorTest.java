...
/**
 * Test that verifies that "inconsistent state" when archetype-content XML generated it IS present in repo root, but the
 * corresponding repository does NOT have indexing context for whatever reason, no NPE happens but the fact is caught by
 * corresponding IOEx.
 * 
 * @author cstamas
 * @since 2.6
