...
public class WLStatusResourceTest
    extends NexusAppTestSupport
{
    ...
    /**
     * Testing does {@link WLStatusResource} honors {@link Repository#isExposed()} flag, since it has to be handled at
    ...
    public void statusUrlHonorsRepoState()
        throws Exception
    {
        final WLStatusResource wlStatusResource = (WLStatusResource) lookup( PlexusResource.class, "WLStatusResource" );
        final Request request = new Request();
        request.setRootRef( new Reference( "http://localhost:8081/nexus" ) );
        request.getAttributes().put( WLResourceSupport.REPOSITORY_ID_KEY, REPO_ID );
        ...
        try
        {
            ...
            {
                final WLStatusMessageWrapper payload = wlStatusResource.get( null, request, null, null );
