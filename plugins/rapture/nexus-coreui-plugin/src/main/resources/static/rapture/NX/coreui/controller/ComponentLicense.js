 ...
 */
/**
 * Component CLM License Details controller.
 *
 * @since 3.0
 */
Ext.define('NX.coreui.controller.ComponentLicense', {
  ...
  onComponentAvailable: function (detailPanel, componentRef) {
    var panel = detailPanel.down('nx-coreui-component-license');

    if (!panel) {
      panel = detailPanel.add({ xtype: 'nx-coreui-component-license' });
    }

    panel.down('#title').setText('License Analysis ' + componentRef.uri);
  },
